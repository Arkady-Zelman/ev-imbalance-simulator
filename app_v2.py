"""
Ohme Fleet Trading — Once UI Redesign (app_v2)
===============================================

Single-page scroll layout with Once UI Magic Portfolio design system.
Sections: Market & Allocation | Demand Map | Summary | Sensitivity

To revert to the original layout: streamlit run app.py
"""
...
# ── Unified sidebar (identical to app.py) ─────────────────────────────────────
